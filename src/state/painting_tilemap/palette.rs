...
impl<'a> TilePalette<'a> {
    ...
    fn local_coords_to_global<R>(
        ...
        local_pos - palette_response.state.offset +
            palette_response.inner_rect.min.to_vec2()
    }
    ...
    fn global_coords_to_local<R>(
        ...
        global_pos - palette_response.inner_rect.min.to_vec2() +
            palette_response.state.offset
    }
